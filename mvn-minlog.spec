...
Source3  : https://repo1.maven.org/maven2/com/esotericsoftware/minlog/1.3/minlog-1.3.jar
Source4  : https://repo1.maven.org/maven2/com/esotericsoftware/minlog/1.3/minlog-1.3.pom
Source5  : https://repo1.maven.org/maven2/com/esotericsoftware/minlog/minlog/1.2/minlog-1.2.jar
Source6  : https://repo1.maven.org/maven2/com/esotericsoftware/minlog/minlog/1.2/minlog-1.2.pom
...
mkdir -p %{buildroot}/usr/share/java/.m2/repository/com/esotericsoftware/minlog/1.3
cp %{SOURCE3} %{buildroot}/usr/share/java/.m2/repository/com/esotericsoftware/minlog/1.3/minlog-1.3.jar

mkdir -p %{buildroot}/usr/share/java/.m2/repository/com/esotericsoftware/minlog/1.3
cp %{SOURCE4} %{buildroot}/usr/share/java/.m2/repository/com/esotericsoftware/minlog/1.3/minlog-1.3.pom

mkdir -p %{buildroot}/usr/share/java/.m2/repository/com/esotericsoftware/minlog/minlog/1.2
cp %{SOURCE5} %{buildroot}/usr/share/java/.m2/repository/com/esotericsoftware/minlog/minlog/1.2/minlog-1.2.jar

mkdir -p %{buildroot}/usr/share/java/.m2/repository/com/esotericsoftware/minlog/minlog/1.2
cp %{SOURCE6} %{buildroot}/usr/share/java/.m2/repository/com/esotericsoftware/minlog/minlog/1.2/minlog-1.2.pom
...
/usr/share/java/.m2/repository/com/esotericsoftware/minlog/1.3/minlog-1.3.jar
/usr/share/java/.m2/repository/com/esotericsoftware/minlog/1.3/minlog-1.3.pom
